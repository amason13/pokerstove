 ...
 */
#ifndef PEVAL_OMAHASIXHANDEVALUATOR_H_
#define PEVAL_OMAHASIXHANDEVALUATOR_H_
...
{
/**
 * A specialized hand evaluator for omaha 6.  Not as slow.
 */
class OmahaSixHandEvaluator : public PokerHandEvaluator
{
public:
...
#endif  // PEVAL_OMAHASIXHANDEVALUATOR_H_
