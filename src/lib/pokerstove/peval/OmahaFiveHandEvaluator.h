 ...
 */
#ifndef PEVAL_OMAHAFIVEHANDEVALUATOR_H_
#define PEVAL_OMAHAFIVEHANDEVALUATOR_H_
...
{
/**
 * A specialized hand evaluator for omaha 5.  Not as slow.
 */
class OmahaFiveHandEvaluator : public PokerHandEvaluator
{
public:
...
#endif  // PEVAL_OMAHAFIVEHANDEVALUATOR_H_
