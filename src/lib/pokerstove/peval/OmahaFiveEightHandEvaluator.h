 ...
 * $Id: OmahaFiveEightHandEvaluator.h 2649 2012-06-30 04:53:24Z prock $
 */
#ifndef PEVAL_OMAHAFIVEEIGHTHANDEVALUATOR_H_
#define PEVAL_OMAHAFIVEEIGHTHANDEVALUATOR_H_
 ...
 */
class OmahaFiveEightHandEvaluator : public PokerHandEvaluator
{
public:
    ...
    virtual PokerHandEvaluation evaluateHand(const CardSet& hand, const CardSet& board) const
    {
        ...
        // 5c2 combinations of hands cards,
    ...
    void fillHands(std::vector<CardSet>& candidates, const CardSet& cards) const
    {
        ...
        candidates[4] = (clist[1] | clist[2]);
        candidates[5] = (clist[1] | clist[3]);
        candidates[6] = (clist[1] | clist[4]);
        candidates[7] = (clist[2] | clist[3]);
        candidates[8] = (clist[2] | clist[4]);
        candidates[9] = (clist[3] | clist[4]);
...
#endif  // PEVAL_OMAHAFIVEEIGHTHANDEVALUATOR_H_
